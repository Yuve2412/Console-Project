...
public class LaptopManagement {
	 ...
	 */
	public LaptopManagement(String brandName,int modelNumber,int price,String storage,String colour,String edition){        // parameterized constructor
		this.brandName=brandName;      // if same methods and attributes this keyword is used  
